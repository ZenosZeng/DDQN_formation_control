...
plt.ylabel('y/m')
plt.legend()
plt.savefig('./record/m201d_trajectory.png')
...
plt.title('y_error')
# plt.legend()
plt.savefig('./record/m201d_XYerror.png')
# finish
print('Error Ploted.')
...
ani.save('./record/m201d_animation.gif') 
