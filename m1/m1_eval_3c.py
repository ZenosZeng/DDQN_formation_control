...
car[1].reset(-0.5,1.5,0)
car[2].reset(-0.5,-1.5,0)
car[3].reset(-1,3,0)
car[4].reset(-1,-3,0)
...
plt.ylabel('y/m')
plt.legend()
plt.savefig('./record/m1_eval_3c_trajectory.png')
...
plt.title('y_error')
# plt.legend()
plt.savefig('./record/m1_eval_3c_xy_error.png')
...
ani.save('./record/m1_eval_3c_animation.gif') #显示动画
