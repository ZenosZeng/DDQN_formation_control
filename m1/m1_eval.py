...
plt.ylabel('y/m')
plt.legend()
plt.savefig('./record/m1_eval_trajectory.png')

# # trajectory 1
# plt.figure(dpi=800)
# time1 = 75
# plt.plot(leader_x_list[:time1],leader_y_list[:time1],color='red',label='Leader',linewidth=0.8)
# plt.plot(follower_x_list[:time1],follower_y_list[:time1],color='green',label='Follower',linewidth=0.8)
# plt.scatter(leader_x_list[:time1][-1],leader_y_list[:time1][-1],color='red',marker='x',linewidth=0.8)                # ,marker='x',linewidth='1'
# plt.scatter(follower_x_list[:time1][-1],follower_y_list[:time1][-1],color='green',marker='x',linewidth=0.8)
# plt.scatter(leader_x_list[:time1][0],leader_y_list[:time1][0],color='red',linewidth=0.8) 
# plt.scatter(follower_x_list[:time1][0],follower_y_list[:time1][0],color='green',linewidth=0.8)
# ax = plt.gca()
# ax.set_aspect(1)
# plt.xlim(xmin,xmax)
# plt.ylim(ymin,ymax)
...
# plt.ylabel('y/m')
# plt.legend()
# plt.savefig('./record/m1_eval_trajectory1.png')

# # trajectory 2
# plt.figure(dpi=800)
# time2 = 150
# plt.plot(leader_x_list[:time2],leader_y_list[:time2],color='red',label='Leader',linewidth=0.8)
# plt.plot(follower_x_list[:time2],follower_y_list[:time2],color='green',label='Follower',linewidth=0.8)
# plt.scatter(leader_x_list[:time2][-1],leader_y_list[:time2][-1],color='red',marker='x',linewidth=0.8)                # ,marker='x',linewidth='1'
# plt.scatter(follower_x_list[:time2][-1],follower_y_list[:time2][-1],color='green',marker='x',linewidth=0.8)
# plt.scatter(leader_x_list[:time2][0],leader_y_list[:time2][0],color='red',linewidth=0.8) 
# plt.scatter(follower_x_list[:time2][0],follower_y_list[:time2][0],color='green',linewidth=0.8)
# ax = plt.gca()
# ax.set_aspect(1)
# plt.xlim(xmin,xmax)
# plt.ylim(ymin,ymax)
...
# plt.ylabel('y/m')
# plt.legend()
# plt.savefig('./record/m1_eval_trajectory2.png')

# # trajectory 3
# plt.figure(dpi=800)
# time3 = 225
# plt.plot(leader_x_list[:time3],leader_y_list[:time3],color='red',label='Leader',linewidth=0.8)
# plt.plot(follower_x_list[:time3],follower_y_list[:time3],color='green',label='Follower',linewidth=0.8)
# plt.scatter(leader_x_list[:time3][-1],leader_y_list[:time3][-1],color='red',marker='x',linewidth=0.8)                # ,marker='x',linewidth='1'
# plt.scatter(follower_x_list[:time3][-1],follower_y_list[:time3][-1],color='green',marker='x',linewidth=0.8)
# plt.scatter(leader_x_list[:time3][0],leader_y_list[:time3][0],color='red',linewidth=0.8) 
# plt.scatter(follower_x_list[:time3][0],follower_y_list[:time3][0],color='green',linewidth=0.8)
# ax = plt.gca()
# ax.set_aspect(1)
# plt.xlim(xmin,xmax)
# plt.ylim(ymin,ymax)
...
# plt.ylabel('y/m')
# plt.legend()
# plt.savefig('./record/m1_eval_trajectory3.png')
...
plt.title('x_error')
# plt.savefig('./record/m1_eval_x_error.png')
...
plt.title('y_error')
plt.savefig('./record/m1_eval_xy_error.png')
...
ani=FuncAnimation(fig,update,interval=30,frames=300-2) #绘制动画
ani.save('./record/m1_eval_animation.gif') #显示动画
